...
//   const fixed_top = document.querySelector(".header");

//   if (window.scrollY > 50) {
//     fixed_top.classList.add("animated", "fadeInDown", "header-fixed");
//   } else {
//     fixed_top.classList.remove("animated", "fadeInDown", "header-fixed");
//   }
// });